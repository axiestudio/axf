...
from axf.base.vectorstores.model import LCVectorStoreComponent, check_cached_vector_store
from axf.base.vectorstores.utils import chroma_collection_to_data
from axf.inputs.inputs import MultilineInput
from axf.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, TabInput
...
class LocalDBComponent(LCVectorStoreComponent):
    ...
    def get_default_persist_dir(self) -> str:
        ...
        from axf.services.cache.utils import CACHE_DIR
