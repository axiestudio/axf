...
from axf.cli.script_loader import (
    extract_structured_result,
    extract_text_from_result,
    find_graph_variable,
    load_graph_from_script,
)
from axf.cli.validation import validate_global_variables_for_env
...
async def run(
    ...
    *,
    ...
    """Execute a AxieStudio graph script or JSON flow and return the result.

    This command analyzes and executes either a Python script containing a AxieStudio graph,
    ...
    try:
        ...
        if file_extension == ".py":
            ...
            from axf.load import aload_flow_from_json
