...
from axf.cli.serve_app import FlowMeta, create_multi_serve_app
...
def serve_command(
    ...
    *,
    ...
    from axf.log.logger import configure
    ...
    try:
        ...
        if resolved_path.suffix == ".json":
            ...
            from axf.cli.script_loader import load_graph_from_script
        ...
        console.print(
            Panel.fit(
                ...
                title="[bold blue]AXF Server[/bold blue]",
                border_style="blue",
            )
        )
        console.print()
