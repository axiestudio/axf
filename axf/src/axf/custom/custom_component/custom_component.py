...
from axf.custom.custom_component.base_component import BaseComponent
from axf.helpers.flow import list_flows, load_flow, run_flow
from axf.log.logger import logger
from axf.schema.data import Data
from axf.services.deps import get_storage_service, get_variable_service, session_scope
from axf.services.storage.service import StorageService
from axf.template.utils import update_frontend_node_with_template_values
from axf.type_extraction import post_process_type
...
if TYPE_CHECKING:
    ...
    from axf.schema.schema import OutputValue
    from axf.services.storage.service import StorageService
...
class CustomComponent(BaseComponent):
    ...
    def tracing_service(self):
        ...
        if self._tracing_service is None:
            from axf.services.deps import get_tracing_service
