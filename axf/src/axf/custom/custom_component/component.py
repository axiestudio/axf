...
from axf.base.tools.constants import (
    TOOL_OUTPUT_DISPLAY_NAME,
    TOOL_OUTPUT_NAME,
    TOOLS_METADATA_INFO,
    TOOLS_METADATA_INPUT_NAME,
)
from axf.custom.tree_visitor import RequiredInputsVisitor
from axf.exceptions.component import StreamingError
from axf.field_typing import Tool  # noqa: TC001

# Lazy import to avoid circular dependency
# from axf.graph.state.model import create_state_model
# Lazy import to avoid circular dependency
# from axf.graph.utils import has_chat_output
from axf.helpers.custom import format_type
from axf.memory import astore_message, aupdate_messages, delete_message
from axf.schema.artifact import get_artifact_type, post_process_raw
from axf.schema.data import Data
from axf.schema.log import Log
from axf.schema.message import ErrorMessage, Message
from axf.schema.properties import Source
from axf.template.field.base import UNDEFINED, Input, Output
from axf.template.frontend_node.custom_components import ComponentFrontendNode
from axf.utils.async_helpers import run_until_complete
from axf.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from axf.base.tools.component_tool import ComponentToolkit
    ...
    from axf.inputs.inputs import InputTypes
    from axf.schema.dataframe import DataFrame
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        try:
            from axf.inputs.inputs import ToolsInput
        except ImportError as e:
            msg = "Failed to import ToolsInput from axf.inputs.inputs"
    ...
    def _ensure_message_required_fields(self, message: Message) -> None:
        ...
        """
        from axf.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI
