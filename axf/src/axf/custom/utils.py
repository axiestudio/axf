...
from axf.custom import validate
from axf.custom.custom_component.component import Component
from axf.custom.custom_component.custom_component import CustomComponent
from axf.custom.dependency_analyzer import analyze_component_dependencies
from axf.custom.directory_reader.utils import (
    abuild_custom_component_list_from_path,
    build_custom_component_list_from_path,
    merge_nested_dicts_with_renaming,
)
from axf.custom.eval import eval_custom_component_code
from axf.custom.schema import MissingDefault
from axf.field_typing.range_spec import RangeSpec
from axf.helpers.custom import format_type
from axf.log.logger import logger
from axf.schema.dotdict import dotdict
from axf.template.field.base import Input
from axf.template.frontend_node.custom_components import ComponentFrontendNode, CustomComponentFrontendNode
from axf.type_extraction.type_extraction import extract_inner_type
from axf.utils.util import get_base_classes
...
async def load_custom_component(component_name: str, components_paths: list[str]):
    ...
    """
    from axf.interface.custom_component import get_custom_component_from_name
