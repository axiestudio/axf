...
from axf.base.prompts.utils import dict_values_to_string
from axf.log.logger import logger
from axf.schema.content_block import ContentBlock
from axf.schema.content_types import ErrorContent
from axf.schema.data import Data
from axf.schema.image import Image, get_file_paths, is_image_file
from axf.schema.properties import Properties, Source
from axf.schema.validators import timestamp_to_str, timestamp_to_str_validator
from axf.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_NAME_USER, MESSAGE_SENDER_USER
from axf.utils.image import create_image_content_dict
...
class Message(Data):
    ...
    def to_dataframe(self) -> DataFrame:
        from axf.schema.dataframe import DataFrame  # Local import to avoid circular import
