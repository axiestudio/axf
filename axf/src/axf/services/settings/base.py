...
from axf.constants import BASE_COMPONENTS_PATH
from axf.log.logger import logger
from axf.serialization.constants import MAX_ITEMS_LENGTH, MAX_TEXT_LENGTH
from axf.services.settings.constants import VARIABLES_TO_GET_FROM_ENVIRONMENT
from axf.utils.util_strings import is_valid_database_url
...
class Settings(BaseSettings):
    ...
    def set_database_url(cls, value, info):
        ...
        if axiestudio_database_url := os.getenv("AXIESTUDIO_DATABASE_URL"):
            ...
            from axf.utils.version import is_pre_release as axiestudio_is_pre_release
