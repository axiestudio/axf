...
from axf.services.schema import ServiceType

if TYPE_CHECKING:
    from axf.services.interfaces import (
...
def get_service(service_type: ServiceType, default=None):
    ...
    """
    from axf.services.manager import get_service_manager
    ...
    if ServiceType.SETTINGS_SERVICE not in service_manager.factories:
        from axf.services.settings.factory import SettingsServiceFactory
...
def get_shared_component_cache_service() -> CacheServiceProtocol | None:
    ...
    from axf.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
