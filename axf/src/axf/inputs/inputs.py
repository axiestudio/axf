...
from axf.inputs.validators import CoalesceBool
...
class MessageInput(StrInput, InputTraceMixin):
    ...
    def _validate_value(v: Any, _info):
        ...
        # This handles both axiestudio and lfx Message instances
...
from axf.template.field.base import Input  # noqa: E402
