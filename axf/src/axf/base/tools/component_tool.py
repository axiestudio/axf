...
from axf.base.tools.constants import TOOL_OUTPUT_NAME
...
class ComponentToolkit:
    ...
    def get_tools(
        ...
        from axf.io.schema import create_input_schema, create_input_schema_from_dict
