...
from axf.exceptions.component import ComponentBuildError
from axf.graph.edge.base import CycleEdge, Edge
from axf.graph.graph.constants import Finish, lazy_load_vertex_dict
from axf.graph.graph.runnable_vertices_manager import RunnableVerticesManager
from axf.graph.graph.schema import GraphData, GraphDump, StartConfigDict, VertexBuildResult
from axf.graph.graph.state_model import create_state_model_from_graph
from axf.graph.graph.utils import (
...
from axf.graph.schema import InterfaceComponentTypes, RunOutputs
from axf.graph.utils import log_vertex_build
from axf.graph.vertex.base import Vertex, VertexStates
from axf.graph.vertex.schema import NodeData, NodeTypeEnum
from axf.graph.vertex.vertex_types import ComponentVertex, InterfaceVertex, StateVertex
from axf.log.logger import LogConfig, configure, logger
from axf.schema.dotdict import dotdict
from axf.schema.schema import INPUT_FIELD_NAME, InputType, OutputValue
from axf.services.cache.utils import CacheMiss
from axf.services.deps import get_chat_service, get_tracing_service
from axf.utils.async_helpers import run_until_complete

if TYPE_CHECKING:
    from collections.abc import Callable, Generator, Iterable
    from typing import Any

    from axf.custom.custom_component.component import Component
    from axf.events.event_manager import EventManager
    from axf.graph.edge.schema import EdgeData
    from axf.graph.schema import ResultData
    from axf.schema.schema import InputValueRequest
    from axf.services.chat.schema import GetCache, SetCache
    from axf.services.tracing.service import TracingService
...
class Graph:
    ...
    async def _log_vertex_build_from_exception(self, vertex_id: str, result: Exception) -> None:
        ...
        if isinstance(result, ComponentBuildError):
            ...
            from axf.utils.exceptions import format_exception_message
