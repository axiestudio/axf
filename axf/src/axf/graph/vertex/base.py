...
from axf.graph.schema import INPUT_COMPONENTS, OUTPUT_COMPONENTS, InterfaceComponentTypes, ResultData
from axf.graph.utils import UnbuiltObject, UnbuiltResult, log_transaction
from axf.graph.vertex.param_handler import ParameterHandler
from axf.interface import initialize
from axf.interface.listing import lazy_load_dict
from axf.log.logger import logger
from axf.schema.artifact import ArtifactType
from axf.schema.data import Data
from axf.schema.message import Message
from axf.schema.schema import INPUT_FIELD_NAME, OutputValue, build_output_logs
from axf.utils.schemas import ChatOutputResponse
from axf.utils.util import sync_to_async
...
if TYPE_CHECKING:
    ...
    from axf.graph.graph.base import Graph
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from axf.interface.components import ensure_component_loaded
        from axf.services.deps import get_settings_service
